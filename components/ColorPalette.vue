...
const sortedColors = computed(() => {
  return [...props.colors].sort((a, b) => {
    ...
    const colorOrder = ['branco', 'preto', 'prata', 'cinza', 'azul', 'vermelho', 'verde', 'amarelo', 'laranja', 'roxo']
...
const toggleColor = (colorId: string) => {
  ...
  emit('change', props.colors.filter(c => newSelection.includes(c.id)))
}
