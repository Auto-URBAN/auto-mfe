<template>
	<div class="space-y-3">
		<div class="flex items-center space-x-2">
			<div :class="['w-6 h-6 rounded-md flex items-center justify-center', iconBgClass]">
...
const filteredOptions = computed(() => {
	...
	if (searchQuery.value && props.searchable) {
		...
		options = options.filter(option => props.getItemLabel(option).toLowerCase().includes(query))
	}
