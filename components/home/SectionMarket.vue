	...
	>
		...
		<UiContainer size="lg">
			...
			<div class="flex items-center justify-center mb-12">
				...
				/>
				<Icon name="mdi:rhombus-split" class="mx-3 w-5 h-5 text-gray-600" />
				<div
					class="h-px flex-1 bg-gradient-to-l from-transparent via-gray-600 to-transparent max-w-xs"
				/>
			</div>
			...
			<div class="text-center mb-12 relative z-10 px-4">
				...
				<h2 class="text-3xl lg:text-5xl font-black text-white mb-4 tracking-tight leading-tight">
					A linha que separa
				...
				<p class="text-gray-300 text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed">
					Quer saber por que o mercado voltou a olhar pra esse modelo?
				</p>
			</div>
			...
			<div class="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10 px-4">
				...
				>
					<div class="flex items-center gap-3 mb-4">
						...
						<div>
							<p
								class="text-4xl font-black text-white tabular-nums group-hover:text-green-400 transition-colors"
							>
								+18<span class="text-2xl">%</span>
							</p>
						</div>
					</div>
					<h3 class="text-lg font-bold text-white mb-2">Valorização Média</h3>
					<p class="text-sm text-gray-400 leading-relaxed">
						Carros premium valorizaram em média
						<span class="text-green-400 font-semibold">18%</span> nos últimos 12 meses.
				...
				>
					<div class="flex items-center gap-3 mb-4">
						<div
							class="relative p-3 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg group-hover:shadow-blue-500/50 transition-shadow"
						>
							<Icon name="mdi:speedometer" class="w-6 h-6 text-white" />
							<div class="absolute inset-0 bg-blue-400 rounded-xl animate-ping opacity-20" />
						</div>
						<div>
							<p
								class="text-4xl font-black text-white tabular-nums group-hover:text-blue-400 transition-colors"
							>
								300<span class="text-2xl">+</span>
							</p>
						</div>
					</div>
					<h3 class="text-lg font-bold text-white mb-2">HP Médio</h3>
					<p class="text-sm text-gray-400 leading-relaxed">
						Potência média dos veículos mais procurados.
					...
					<div class="mt-4 flex items-center gap-2">
						<div class="flex-1 h-2 bg-gray-700 rounded-full overflow-hidden">
							<div
								class="h-full bg-gradient-to-r from-blue-500 to-blue-400 rounded-full animate-progress-bar-delayed"
								style="width: 85%"
							/>
						</div>
				...
				>
					<div class="flex items-center gap-3 mb-4">
						<div
							class="relative p-3 bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-lg group-hover:shadow-purple-500/50 transition-shadow"
						>
							<Icon name="mdi:clock-fast" class="w-6 h-6 text-white" />
							<div class="absolute inset-0 bg-purple-400 rounded-xl animate-ping opacity-20" />
						</div>
						<div>
							<p
								class="text-4xl font-black text-white tabular-nums group-hover:text-purple-400 transition-colors"
							>
								48<span class="text-2xl">h</span>
							</p>
						</div>
					</div>
					<h3 class="text-lg font-bold text-white mb-2">Tempo Médio de Venda</h3>
					<p class="text-sm text-gray-400 leading-relaxed">
						Carros bem avaliados saem em menos de 2 dias.
					...
					<div class="mt-4 flex items-center gap-2">
						...
						<div class="flex-1 h-2 bg-gray-700 rounded-full overflow-hidden">
							<div
								class="h-full bg-gradient-to-r from-purple-500 to-purple-400 rounded-full animate-progress-bar-delayed-2"
								style="width: 60%"
							/>
						</div>
					</div>
			...
			<div class="mt-12 text-center relative z-10 px-4">
				...
				>
					...
					<span class="relative z-10">Explorar inteligência de mercado</span>
					<Icon
						name="mdi:chart-box-outline"
						class="relative z-10 w-5 h-5 group-hover:rotate-12 transition-transform duration-300"
					/>
				</NuxtLink>
			</div>
...
.animate-progress-bar {
	animation: progress-bar 2s ease-out 0.5s both;
}

.animate-progress-bar-delayed {
	animation: progress-bar 2s ease-out 0.8s both;
}

.animate-progress-bar-delayed-2 {
	animation: progress-bar 2s ease-out 1.1s both;
}
