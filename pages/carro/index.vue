        ...
        <div class="flex-1 min-w-0">
          <div class="mb-6">
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              ...
              <div v-if="selectedModels.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div
                ...
                >
                  ...
                  <div class="space-y-2 text-xs">
                    <div v-if="getFieldEnabled('horsepower')" class="flex items-center justify-between py-1.5 border-t border-gray-100">
                    ...
                    <div v-if="getFieldEnabled('year')" class="flex items-center justify-between py-1.5 border-t border-gray-100">
                      <div class="flex items-center gap-1.5 text-gray-600">
                    ...
                    <div v-if="getFieldEnabled('transmission') && (model as any).transmission" class="flex items-center justify-between py-1.5 border-t border-gray-100">
                      <div class="flex items-center gap-1.5 text-gray-600">
                        <Icon name="heroicons:cog-6-tooth-20-solid" class="w-3.5 h-3.5 text-indigo-500" />
                        <span>Câmbio</span>
                      </div>
                      <span class="font-bold text-gray-900">{{ (model as any).transmission }}</span>
                    </div>
                    <div v-if="getFieldEnabled('fuel') && (model as any).fuel" class="flex items-center justify-between py-1.5 border-t border-gray-100">
                      <div class="flex items-center gap-1.5 text-gray-600">
                    ...
                    <div v-if="getFieldEnabled('maintenanceCost')" class="flex items-center justify-between py-1.5 border-t border-gray-100">
                      <div class="flex items-center gap-1.5 text-gray-600">
                        <Icon name="heroicons:wrench-screwdriver-20-solid" class="w-3.5 h-3.5 text-yellow-600" />
                    ...
                    <div v-if="getFieldEnabled('insuranceCost')" class="flex items-center justify-between py-1.5 border-t border-gray-100">
                      <div class="flex items-center gap-1.5 text-gray-600">
                        <Icon name="heroicons:shield-check-20-solid" class="w-3.5 h-3.5 text-green-600" />
                        <span>Seguro</span>
                      </div>
                      <span class="font-bold text-gray-900">{{ formatCurrency(getInsuranceCost(model)) }}</span>
                    </div>
                    <div v-if="getFieldEnabled('depreciation')" class="border-t border-gray-100 pt-3 mt-2">
              ...
              >
                <div class="max-w-md mx-auto">
                  <div class="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <Icon name="heroicons:cursor-arrow-ripple-20-solid" class="w-8 h-8 text-gray-300" />
                  </div>
          ...
          <div v-else-if="filteredModels.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            <div
          ...
          <div v-else class="text-center py-16">
            <Icon name="heroicons:magnifying-glass-20-solid" class="w-20 h-20 text-gray-300 mx-auto mb-4" />
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Compare até 4 modelos lado a lado: especificações, preços, potência e características técnicas.' }
  ]
})
