...
export const RejectVehicleRequest = z.object({
  vehicleId: z.string().min(1),
  reason: z.string().min(10, 'Rejection reason must be at least 10 characters').max(500, 'Reason too long')
})
...
export const DashboardData = z.object({
  ...
  recentActivity: z.array(z.object({
    id: z.string(),
    type: z.enum(['vehicle_created', 'vehicle_approved', 'vehicle_rejected', 'user_registered']),
