	...
	try {
		...
		const mockVehicles = [
			...
			},
			{
				...
				uf: 'DF',
				coverImageUrl:
					'https://s3.ecompletocarros.dev/images/lojas/558/veiculos/218494/veiculoInfoVeiculoImagesMobile/vehicle_image_1735271875_d41d8cd98f00b204e9800998ecf8427e.jpeg',
				status: 'PENDING' as VehicleStatus,
			...
			},
			{
				...
				uf: 'BA',
				coverImageUrl:
					'https://editorial.pxcrush.net/carsales/general/editorial/2019-mercedes-c63-sandown-034.jpg?width=1024&height=682',
				status: 'APPROVED' as VehicleStatus,
